...
# Set image metadata
LABEL version="1.0"
LABEL description="Laravel based Graphql API for the five things application suite"

# Set the web root from which nginx serves our app
ENV WEB_DOCUMENT_ROOT="/var/www/public"

# Install various packages, php extensions and composer
RUN apt-get update && apt-get install -y libmcrypt-dev mariadb-client zip libzip-dev libpq-dev libpng-dev \
